...
/**
 * ITS 2.0 Language Quality Issue Data Category creation form. Follows:
 * http://www
 * .w3.org/International/multilingualweb/lt/drafts/its20/its20.html#lqissue
 */
public class NewLanguageQualityIssueView extends JPanel implements Runnable,
        ActionListener {
	private static final long serialVersionUID = 3L;
	private static Logger LOG = LoggerFactory
	        .getLogger(NewLanguageQualityIssueView.class);
	...
	public static final String[] LQI_TYPE = { "terminology", "mistranslation",
	...
	private void addSeverity(GridBagConstraints gridBag) {
		...
		severitySpinner.setEditor(new JSpinner.NumberEditor(severitySpinner,
		        "0.000000000"));
	...
	public void updateSegment() {
		segmentId.setText(selectedSeg.getSegmentNumber() + "");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == cancel) {
			...
			if (addingLQI()) {
				...
				eventQueue.post(new LQIEditEvent(lqi, this.selectedLQI, selectedSeg,
				        this.selectedLQI));
			}
